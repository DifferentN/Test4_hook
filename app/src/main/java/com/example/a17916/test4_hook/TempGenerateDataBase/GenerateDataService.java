...
public class GenerateDataService extends Service {
    public static final String GENERATE_INTENT_DATA = "GENERATE_INTENT_DATA";
    ...
    public static final String GENERATE_EVENT_DATA = "GENERATE_EVENT_DATA";
    ...
    public void onCreate() {
        ...
        intentFilter.addAction(GenerateDataService.GENERATE_INTENT_DATA);
        intentFilter.addAction(MonitorActivityService.SAVE_INTENT);
